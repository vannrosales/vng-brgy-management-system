    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-semibold text-[#1B385D] ">Community News</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {newsList.map((news, idx) => (
                    <div key={idx} className="bg-white border border-gray-200 overflow-hidden flex flex-col justify-between hover:shadow-md transition-shadow">
                        ...
                        <div className="p-5">
                            <span className="text-[10px] font-semibold px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 inline-block mb-3">{news.tag}</span>
                            <h3 className="font-semibold text-base text-gray-900 mb-1">{news.title}</h3>
