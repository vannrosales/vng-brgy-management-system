...
export default function WelcomeBanner({ userName, pendingCount, meetingTitle }) {
    return (
        <div className="bg-[#1B385D] text-white p-8 shadow-sm relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-6 rounded-2xl">
            <div>
            ...
            <div className="flex flex-wrap gap-3">
                <button className="bg-white text-[#1B385D] font-semibold px-4 py-2.5 rounded-xl text-sm hover:bg-blue-50 transition-colors shadow-sm">
                    View My Requests
                </button>
